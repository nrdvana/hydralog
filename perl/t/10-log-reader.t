...
like( $reader,
	object {
		...
		call fields => [qw( timestamp level message )],
	},
	'reader object'
);
...
like( $reader->next,
	object {
		call timestamp => 0;
		call timestamp_epoch => 1577836800;
		call timestamp_gmtime => '2020-01-01T00:00:00Z';
		call level => 'INFO';
...
like( $reader->next,
	object {
		call timestamp => 16;
		call timestamp_epoch => 1577836800+16;
		call timestamp_gmtime => '2020-01-01T00:00:16Z';
		call level => 'WARN';
